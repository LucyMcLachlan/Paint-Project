...
void draw() {
  ...
  //stamp button
  fill(white);
  tactileRect(605, 185, 670, 285);
  if(sunflowerOn==true){
  stroke(navy);
  }
  rect(605, 185, 70, 100);
  image(sunflower, 600, 185, 75, 100);
}
...
void mouseReleased() {
  ...
  //sunflower button
  if (mouseX>605 && mouseX<670 && mouseY>185 && mouseY<285) {
    sunflowerOn = !sunflowerOn;
  }
  ...
  //sunflower
  if(sunflowerOn==true){
     if (mouseX>110 && mouseX<490 && mouseY>70 && mouseY<520 && pmouseX>110 && pmouseX<490 && pmouseY>70 && pmouseY<520) {
   image(sunflower, mouseX, mouseY, 75, 100);
 }
  }
}
void mouseDragged() {
  if (sunflowerOn==false) {
    drawLine();
  } else {
    //sunflower drawing
     if (mouseX>110 && mouseX<490 && mouseY>70 && mouseY<520 && pmouseX>110 && pmouseX<490 && pmouseY>70 && pmouseY<520) {
